    ...
    <div class="card-body">
      <form method="post" action="{{ route('admin.unit.store') }}">
        ...
        <div class="form-group{{ $errors->has('unit_identity') ? ' has-danger' : '' }}">
          ...
          <input type="text" name="unit_identity" value="{{ old('unit_identity') }}" class="form-control">
        ...
        <div class="form-group{{ $errors->has('va_number') ? ' has-danger' : '' }}">
          ...
          <input type="text" name="va_number" value="{{ old('va_number') }}" class="form-control">
        ...
        <div class="form-group{{ $errors->has('capacious') ? ' has-danger' : '' }}">
          <label class="form-control-label">Luas Unit/mm<sup>2</sup></label>
          <input type="text" name="capacious" value="{{ old('capacious') }}" class="form-control">
        ...
        <div class="form-group{{ $errors->has('floor_id') ? ' has-danger' : '' }}">
          ...
          <select name="floor_id" class="form-control select2">
            ...
            <option {{ old('floor_id') == $floor->id ? 'selected' : '' }} value="{{ $floor->id }}">{{ $floor->name }}</option>
            @endforeach
          </select>
        ...
        <div class="form-group{{ $errors->has('block_id') ? ' has-danger' : '' }}">
          ...
          <select name="block_id" class="form-control select2">
            ...
            <option {{ old('block_id') == $block->id ? 'selected' : '' }} value="{{ $block->id }}">{{ $block->name }}</option>
            @endforeach
          </select>
